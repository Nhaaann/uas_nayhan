...
class _DetailState extends State<Detail> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              _scrollItem(images),
              SizedBox(height: 24),
              _detailProduk(text, images, subtText, harga),
              SizedBox(height: 24),
              ...
              onTap: () {
                if (cartProvider.jumlah == 0) {
                  NotificationUtils.showNotification(
                      context, 'Barang minimal harus 1', 245);
                } else {
                  ...
                  NotificationUtils.showNotification(
                      context, 'Item ditambahkan ke keranjang', 298);
                }
  ...
  Column _detailProduk(String text, String img, String subtText, int harga) {
    return Column(
          ...
          children: [
            ...
            LikeButton(
              ...
              onTap: (bool isLiked) async {
                ...
                NotificationUtils.showNotification(
                    context, 'item ditambahkan ke Wishlist', 281.5);
                return !isLiked;
              },
            ),
          ],
  ...
  SingleChildScrollView _scrollItem(String images) {
    return SingleChildScrollView(
      ...
      child: Row(
        ...
        children: [
          ...
          _DetailItems('assets/images/Rectangle 25.png'),
          SizedBox(width: 16),
          _DetailItems('assets/images/Rectangle 26.png'),
          SizedBox(width: 16),
          _DetailItems('assets/images/Rectangle 27.png'),
          SizedBox(width: 16),
          _DetailItems('assets/images/Rectangle 23.png'),
          SizedBox(width: 16),
          _DetailItems('assets/images/Rectangle 26.png'),
          SizedBox(width: 16),
          _DetailItems('assets/images/Rectangle 27.png'),
  ...
  Container _DetailItems(String img) {
    return Container(
      width: 64,
      height: 64,
      decoration: BoxDecoration(
